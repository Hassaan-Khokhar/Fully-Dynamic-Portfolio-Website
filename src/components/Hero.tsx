...
export default function Hero({ contact }: { contact: any }) {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-20 relative overflow-hidden">
      ...
      <motion.div style={{ y: y1 }} className="absolute top-1/4 left-1/4 w-96 h-96 bg-neon-blue/20 rounded-full blur-[120px] mix-blend-screen sm:animate-pulse pointer-events-none will-change-transform" />
      <motion.div style={{ y: y2 }} className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-neon-purple/20 rounded-full blur-[120px] mix-blend-screen sm:animate-pulse delay-1000 pointer-events-none will-change-transform" />
