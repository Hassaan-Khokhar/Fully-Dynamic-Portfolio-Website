        ...
        >
          {displayCategories.map((category) => (
            <motion.div
              ...
              className={`relative glass rounded-3xl p-px hover:bg-[var(--glass-bg-color)] transition-all duration-500 ease-out hover:scale-[1.02] flex flex-col overflow-hidden ${category.className || "md:col-span-1 md:row-span-1"}`}
            >
              <motion.div
